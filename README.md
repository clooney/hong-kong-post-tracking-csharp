# Hong Kong Post Tracking API For Csharp
Hong Kong Post Tracking API and webhook make it easy to integrate Hong Kong Post Tracking function into your own project. Support APIs Client Libraries for csharp

### API key

In order to use this API, you need to generate a Hong Kong Post Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Hong Kong Post Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Hong Kong Post Tracking API](https://www.trackingmore.com/hong-kong-post-tracking.html)  to:

   *   Get Hong Kong Post realtime tracking info of muti-carriers in one integration
   *   Provide Hong Kong Post shipment tracking experience like Amazon
   *   Push Hong Kong Post notifications of package update with webhook
   *   Verify Hong Kong Post delivery exception before it is too late
